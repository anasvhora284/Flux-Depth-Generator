      ...
      <main className="flex-1">
            ...
            >
              {[
                ...
                <motion.div key={i} variants={item}>
                  <Card className="h-full border-white/5 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors">
                    <CardHeader>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <Card key={i} className="border-white/5 bg-black/20 hover:border-blue-500/30 transition-all group">
                  <CardHeader>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-heading text-4xl md:text-6xl font-bold mb-8">Ready to create in 3D?</h2>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/dashboard">
                <Button className="h-14 px-10 text-lg bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-500/25 transition-all hover:scale-105">
                  Start Creating Now
                </Button>
              </Link>
            </div>
